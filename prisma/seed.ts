...
async function main() {
  ...
  const approvalsData = [
    {
      ...
      oldStatus: RequisitionStatus.MANAGER_REVIEW,
    ...
    },
    {
      ...
      oldStatus: RequisitionStatus.FINANCE_REVIEW,
  ...
  const settings: Array<[string, string]> = [
    ...
    ["sla.managerReviewDays", "2"],
    ["sla.procurementReviewDays", "3"],
    ["sla.financeReviewDays", "2"],
    [
